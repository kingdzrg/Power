...
message.channel.send(`Power Show You The Avatar For ${user} Power :  : ${user.avatarURL}`);
}
});
   ...
   client.on('message', message => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .addField('``My Ping``' , [`${Date.now() - message.createdTimestamp}` + 'Power MS'], true)
            ...
            .addField('``My ID``' , `[ ${client.user.id} ]` , true)
                  ...
                  .addField('``My Language``' , `[ Power ]` , true)
                    })
}
});
